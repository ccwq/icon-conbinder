    ...
    <main class="workspace">
      <aside class="panel panel-left">
        ...
        <div class="panel-content">
          ...
          <div class="param-group">
            <div class="group-head">
              <span>图像参数</span>
              <span class="mono-chip">scale / offset</span>
            </div>
            <div class="param-row">
              ...
              <div class="range-group">
                ...
                <span class="range-value">{{ form.imageScale.toFixed(2) }}</span>
              </div>
            </div>
            <div class="param-row">
              <div class="param-head">
              ...
              <div class="range-group">
                ...
                <span class="range-value">{{ form.imageOffsetY }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="param-row">
            ...
            <div class="range-group">
              ...
              <span class="range-value">{{ form.iconSize }}</span>
            </div>
          </div>
      ...
      <section class="preview-zone">
        ...
        <div class="preview-stage">
          <div class="preview-frame" :class="{ rendering: isRendering }">
            <div class="preview-grid"></div>
            <div class="preview-safety-ring"></div>
            <img
              v-if="previewUrl"
              :src="previewUrl"
              alt="预览"
...
.preview-frame {
  ...
  box-shadow:
    ...
    inset 0 0 0 16px rgba(255, 255, 255, 0.01),
